        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 1:
              user = _d.sent();
              //convert dob from birthdate to age in years
              user.dataValues.dob = calculateAgeFromBirthdate(
                user.dataValues.dob
              );
              return [
                4 /*yield*/,
            ...
            case 4:
              ...
              for (i = 0; i < imagesArray.dataValues.userAlbums.length; i++) {
                images.push({
                  ...
                  imageUrl:
                    imagesArray.dataValues.userAlbums[i].dataValues.imageURL,
                });
              }
              ...
              return [
                ...
                db.Chats.findAll({
                  where:
                    ((_c = {}),
                    (_c[Op.or] = [{ user1Id: idStr }, { userId: idStr }]),
                    _c),
                }),
              ];
            case 5:
                ...
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    ...
                    if (
                      ...
                      chat.dataValues.userId.toString()
                    )
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                db.User.findAll({ where: { city: input.city } }),
              ];
            case 1:
              users = _c.sent();
              returnedUsers = [];
              _loop_1 = function (i) {
                ...
                return __generator(this, function (_e) {
                  switch (_e.label) {
                    case 0:
                      users[i].dataValues.dob = calculateAgeFromBirthdate(
                        users[i].dataValues.dob
                      );
                      return [
                        4 /*yield*/,
                    ...
                    case 4:
                      ...
                      for (
                        i_1 = 0;
                        i_1 < imagesArray.dataValues.userAlbums.length;
                        i_1++
                      ) {
                        images.push({
                          photoId:
                            imagesArray.dataValues.userAlbums[i_1].dataValues
                              .id,
                          imageUrl:
                            imagesArray.dataValues.userAlbums[i_1].dataValues
                              .imageURL,
    ...
    languages: function (_, __, _a) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [4 /*yield*/, db.Language.findAll()];
            case 1:
              langauges = _b.sent();
    ...
    interests: function (_, __, _a) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [4 /*yield*/, db.Interests.findAll()];
            case 1:
              interests = _b.sent();
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                db.Chats.findAll({ where: { user1Id: input.id } }),
              ];
            case 1:
              chats = _c.sent();
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                db.UserAlbum.findAll({ where: { userId: input.id } }),
              ];
            case 1:
              photos = _c.sent();
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                db.Messages.findAll({ where: { chatId: input.chatId } }),
              ];
            case 1:
              messages = _c.sent();
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                db.Reviews.findAll({ where: { userId: input.userId } }),
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                db.User.findOne({
                  where: { id: reviews[i].dataValues.authorId },
                }),
              ];
            case 3:
              author = _c.sent();
            ...
            case 4:
              ...
              return [3 /*break*/, 2];
            case 5:
              return [2 /*return*/, returnedReviews];
          }
        });
      });
    },
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                user.addLanguage(input.languages[i], user.dataValues.id),
              ];
            case 3:
              _c.sent();
              _c.label = 4;
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                user.addInterests(input.interests[i], user.dataValues.id),
              ];
            case 7:
              _c.sent();
              _c.label = 8;
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                db.UserAlbum.destroy({ where: { id: input.id } }),
              ];
            case 1:
              photo_1 = _c.sent();
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                db.User.findOne({ where: { id: input.authorId } }),
              ];
            case 2:
              author = _c.sent();
              return [
